...
const namePrefix = "noughts and crosses";
const description = "classic noughts and crosses game, collection of 5,000 gameboards with various stages of play";
...
const extraMetadata = {
  external_url: "https:/www.mintingames.com", // Replace with your website or remove this line if you do not have one.
};
...
const PRESALE_MINT_START_DATE = "2022-09-09T11:30:48+00:00"; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 500; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0xe3fE29d1270455Ec66772eAc17a4CeC8be922f88"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xa66572B501c707a0A09e71B834D6ed5fd10685b2"]; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x320Cd56ed5C55aAC76943B90B505A5a39019e690"; // If you want to manually include it
...
const solanaMetadata = {
  ...
  external_url: "www.mintingames.com",
  creators: [
    {
      address: "",
      share: 0,
